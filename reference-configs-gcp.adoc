...
. Pour obtenir une prise en charge par région de Google Cloud Platform, consultezla section https://cloud.netapp.com/cloud-volumes-global-regions["Régions Cloud volumes Global"^].
