...
* link:media/notice-aws.pdf["Avis au Médiateur Cloud Volumes ONTAP 9.12.0 dans AWS"^]
* link:media/notice-google-cloud.pdf["Avis pour le médiateur Cloud Volumes ONTAP 9.12.0 dans Google Cloud"^]
